...
// =====================================================================
// LAST REVISION: 01-NOVEMBER-2020 
// MODE:
...
#include <Wire.h> // Wire Bibliothek einbinden
 ...
 LiquidCrystal_I2C lcd(0x3F, 16,1); //Hier wird festgelegt um was für einen Display es sich handelt. In diesem Fall eines mit 16 Zeichen in 2 Zeilen und der HEX-Adresse 0x27. Für ein vierzeiliges I2C-LCD verwendet man den Code "LiquidCrystal_I2C lcd(0x27, 20, 4)" 
...
{
  Serial.begin(9600);
   lcd.init(); // inititialize the LCD Dissplay
   lcd.backlight(); // LCD backlight on

  lcd.setCursor(0,0);
  lcd.print("TRACKDUINO2-V1.0");
   lcd.setCursor(0,1);
   lcd.print("by Giu MacGyver");
     delay(2000);
   lcd.clear();
  ...
  //attachInterrupt(digitalPinToInterrupt(interrupt0Pin), int0, FALLING);
...
//
// read sector header
// Header: FF FF FF 52 54 B5 29 4B 7A 5E 95 55 55  (08 ID1 ID2 TR SE CRC Sync)
// Sector: FF FF FF 55 D4 A5 29 4A 52 94 A5 29 4A ...  (07 xx xx xx ... CRC Sync)
//
int StartReadSector()
{
...
void PrintTrack()
{
  ...
  // --------LCD Display output -----
//    lcd.setCursor(0,1);    // Untere Zeile Anzeige
//    lcd.print("Track: ");
//    lcd.print(track);
//    lcd.print(" HT: ");
//    lcd.print(halfTrack);
//    lcd.setCursor(0,0);  // Obere  Zeile Anzeige
//    lcd.print( "Stepper:");
//    lcd.print(GetStepper());
